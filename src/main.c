...
bool key1Pushed = 0;          // Current pushbutton status.
bool key2Pushed = 0;          // Current pushbutton status.
bool key3Pushed = 0;          // Current pushbutton status.
bool key4Pushed = 0;          // Current pushbutton status.
bool key0Pushed = 0;          // Current pushbutton status.
